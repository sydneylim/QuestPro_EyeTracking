...
public class BodyStabilized : MonoBehaviour
{
    public GameObject bodyStabilized;
    ...
    public void StartEvaluation()
    {
        ...
        currentObject = bodyStabilized;
        grid = bodyStabilized.transform.Find("Positions").gameObject;
        edges = bodyStabilized.transform.Find("Edges").gameObject;
        ...
        transform.position = start.position + leftHandController.transform.position;
    ...
    IEnumerator Evaluation()
    {
        ...
        filename = "bodyStabilized_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".csv";
        frameNumber = 0;
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            while (timeElapsed < pathTime || transform.position + leftHandController.transform.position != end.position + leftHandController.transform.position)
            {
                movement = "moving";
                transform.position = Vector3.Lerp(start.position + leftHandController.transform.position, end.position + leftHandController.transform.position, Mathf.Min(timeElapsed / pathTime, 1));
